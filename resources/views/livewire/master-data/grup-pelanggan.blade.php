                            ...
                            <tbody>
                                @forelse ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->kode }}</td>
                                        <td>{{ $row->grup }}</td>
                                        <td>{{ number_format($row->potongan) }}.00</td>
                                        <td>{{ $row->level_harga }}</td>
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" wire:model="potongan" id="potongan" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="level_harga">Level Harga</label>
                            <input type="number" wire:model="level_harga" id="level_harga" class="form-control">
                        </div>
                    </div>
