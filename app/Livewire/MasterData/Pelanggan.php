...
class Pelanggan extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.master-data.pelanggan', compact('data'))->title('Mitra Pengguna | Pelanggan');
    }
    ...
    {
        $latestData = MitraPengguna::where('role', 'Pelanggan')->latest('kode')->first();

        $urutan = ($latestData) ? (int)substr($latestData->kode, 4) + 1 : 1;

        $kode = "PLG-" . sprintf("%04s", $urutan);
        return $kode;
    }
